...
\begin{figure}[H]
    ...
    \addplot[green, mark=x, mark size=0pt, samples=100, domain=-60:115] {1850.15*e^(-0.037403*(-90.6604+x)^2)};
    \addplot[blue, mark=x, mark size=0pt, samples=100, domain=190:270] {4367.33*e^(-0.00790729*(-232.226+x)^2)};
    \end{axis}
    \end{tikzpicture}
    \captionof{figure}{}
\end{figure}
...
\begin{center}
  \begin{tabular}{r|l|l|l}
           & k         & $\mu$     & $\sigma$  \\ \hline
     xray  & $16956,2$ & $90,6604$ & $3,65621$ \\ \hline
     gamma & $87051,7$ & $232,226$ & $7,9519$ \\
	\end{tabular}
\end{center}
...
\begin{figure}[H]
    ...
    \addplot[green, mark=x, mark size=0pt, samples=100, domain=-60:115] {2401.28*e^(-0.00245762*(-108.445+x)^2)};
    \addplot[blue, mark=x, mark size=0pt, samples=100, domain=190:270] {963.17*e^(-0.0180637*(-235.828+x)^2)};
    \end{axis}
    \end{tikzpicture}
    \captionof{figure}{}
\end{figure}
...
\begin{center}
  \begin{tabular}{r|r@{,}l|r@{,}l|r@{,}l}
           & \multicolumn{2}{c|}{k}         & \multicolumn{2}{c|}{$\mu$}     & \multicolumn{2}{c}{$\sigma$}  \\ \hline
     xray  & $85853$ &$9$ & $108$&$445$ & $14$&$2635$ \\ \hline
     gamma & $12702$ &$1$ & $235$&$828$ & $5$&$26116$ \\
	\end{tabular}
\end{center}

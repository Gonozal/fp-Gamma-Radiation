...
\begin{figure}[H]
    ...
    \addplot[green, mark=x, mark size=0pt, samples=100, domain=-60:115, thick] {1846.49*e^(-0.0367783*(-90.6847+x)^2)};
...
\begin{center}
  \begin{tabular}{r|r|r|r|r|r|r}
     ...
     xray         & $17066$ & $597$      & $90,7$  & $0,14$       & $3,69$   & $0,16$          \\ \hline
...
\begin{figure}[H]
    ...
    \addplot[green, mark=x, mark size=0pt, samples=120, domain=130:180, thick] {5608.36*e^(-0.0450679*(-145.616+x)^2)};
...
\begin{figure}[H]
    ...
    \addplot[green, mark=x, mark size=0pt, domain=0:40, thick] {27.1052 + 1.84225*x};
    \end{axis}
    \end{tikzpicture}
...
Using the rise of the graph $m=1,84$ we \caption{}n calculate $E_{eff}=\frac{m^2}{8ln2}$
to $E_{eff}=0,610 keV$.

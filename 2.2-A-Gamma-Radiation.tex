...
\begin{figure}[H]
    ...
    \addplot[red, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Cs137-1.txt};
    \end{axis}
    \end{tikzpicture}
    \captionof{figure}{}
\end{figure}
...
\begin{figure}[H]
    ...
    \addplot[red, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Cs137-AL-backscattering.txt};
    \addlegendentry{Aluminium Plate}
    \addplot[green, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Cs137-Cd-backscattering.txt};
    \addlegendentry{Cadmium Plate}
    \addplot[blue, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Cs137-Fe-backscattering.txt};
    \addlegendentry{Iron Plate}
    \addplot[orange, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Cs137-Pb-backscattering.txt};
...
\begin{figure}[H]
    ...
    \addplot[red, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Cs137-Pb-shield.txt};
    \addlegendentry{Aluminium Plate}
    \end{axis}
    \end{tikzpicture}
    \captionof{figure}{}
...
\begin{figure}[H]
    ...
    \addplot[red, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Na22.txt};
    \end{axis}
    \end{tikzpicture}
    \captionof{figure}{}
\end{figure}
...
\begin{figure}[H]
    ...
    \addplot[red, only marks, mark=x, mark size=1pt] table[x index=0, y index=1] {data/Na22-sum.txt};
    \end{axis}
    \end{tikzpicture}
    \captionof{figure}{}
\end{figure}
